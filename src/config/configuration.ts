...
export default () => ({
  ...
  app_url:'https://7ba6-223-233-76-207.ngrok-free.app',
  app_install_URL:'https://7ba6-223-233-76-207.ngrok-free.app/shopify/auth/redirect',
  ...
  jwt_token_audience: process.env.JWT_TOKEN_AUDIENCE ?? 'https://7ba6-223-233-76-207.ngrok-free.app',
