...
export default () => ({
  ...
  app_install_URL:'https://ce6d-223-233-68-44.ngrok-free.app/shopify/auth/redirect',
  ...
  jwt_token_audience: process.env.JWT_TOKEN_AUDIENCE ?? 'https://ce6d-223-233-68-44.ngrok-free.app',
